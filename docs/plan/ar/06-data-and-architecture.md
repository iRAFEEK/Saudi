...
|---|---|---|
| إطار التطبيق | مستودع أحادي (monorepo) بإطار Next.js (TypeScript) — تطبيق PWA للعميل + لوحة الإدارة + صفحات الروابط السحرية | قاعدة كود واحدة، وSSR لصفحات الروابط، وقابلية التثبيت كتطبيق PWA؛ والأغلفة الأصلية (Expo/Capacitor) في المرحلة 2 |
